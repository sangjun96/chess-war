...
function HUD.draw(theme, fonts, board, camera, flow, statusMessage)
    ...
    love.graphics.print((flow.finished and "Game over" or flow.activeTeam .. " team's turn"), panelX + 16, panelY + 65)
    ...
    love.graphics.print(flow.finished and flow.status or statusMessage, panelX + 16, panelY + 153)
